...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file',type=str, default='data/ace_en/train.jsonl')
    parser.add_argument('--val-file', type=str, default='data/ace_en/dev.jsonl')
    parser.add_argument('--test-file', type=str, default='data/ace_en/test.jsonl')
